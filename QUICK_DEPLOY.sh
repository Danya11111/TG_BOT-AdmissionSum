...
echo -e "\n${GREEN}[1/8]${NC} Обновление системы..."
sudo apt update
sudo apt upgrade -y

# Шаг 2: Установка зависимостей
echo -e "\n${GREEN}[2/8]${NC} Установка зависимостей..."
...
echo -e "\n${GREEN}[3/8]${NC} Создание виртуального окружения Python..."
if [ ! -d "venv" ]; then
...
# Шаг 4: Настройка .env
echo -e "\n${GREEN}[4/8]${NC} Настройка переменных окружения..."
if [ ! -f ".env" ]; then
...
echo -e "\n${GREEN}[6/8]${NC} Миграция данных в Qdrant..."
...
echo -e "\n${GREEN}[7/8]${NC} Создание systemd сервиса..."
...
echo -e "\n${GREEN}[8/8]${NC} Запуск бота через systemd..."
